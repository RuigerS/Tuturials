...
public class MendixSSOUser extends system.proxies.User
{
	 ...
	 */
	public static final java.lang.String entityName = "DataGathering.MendixSSOUser";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "DataGathering.MendixSSOUser"));
	}
	...
	protected MendixSSOUser(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixSSOUserMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("DataGathering.MendixSSOUser", mendixSSOUserMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a DataGathering.MendixSSOUser");
	}
	...
	public static datagathering.proxies.MendixSSOUser initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return datagathering.proxies.MendixSSOUser.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static datagathering.proxies.MendixSSOUser initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new datagathering.proxies.MendixSSOUser(context, mendixObject);
	}

	public static datagathering.proxies.MendixSSOUser load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return datagathering.proxies.MendixSSOUser.initialize(context, mendixObject);
	}

	public static java.util.List<datagathering.proxies.MendixSSOUser> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<datagathering.proxies.MendixSSOUser> result = new java.util.ArrayList<datagathering.proxies.MendixSSOUser>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//DataGathering.MendixSSOUser" + xpathConstraint))
			result.add(datagathering.proxies.MendixSSOUser.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final datagathering.proxies.MendixSSOUser that = (datagathering.proxies.MendixSSOUser) obj;
	...
	{
		return "DataGathering.MendixSSOUser";
	}
